   ...
   return (
      <GridLayout>
         <Flex
            ...
            whileInView={'animate'}
         >
            <Flex flex='1' flexDir={'column'} gap='40px' justify='center' as={motion.div} variants={variants}>
               <Text as={motion.h1} variants={variants} fontSize={'100px'} lineHeight={'88px'}>
                  Let&apos;s work together
               </Text>
               <Box as={motion.div} variants={variants}>
                  <Text as='h2'>Mail</Text>
                  <Text as='span' fontWeight={'300'}>
                     jobayed803@gmail.com
                  </Text>
               </Box>
               <Box as={motion.div} variants={variants}>
            ...
            <Box flex='1' pos='relative'>
               <motion.div
                  ...
                  style={{ stroke: 'orange', position: 'absolute', margin: 'auto' }}
               >
            ...
            C32.666,7.326,25.339,0,16.333,0z'
               ...
               >
                  ...
                  <Textarea rows={10} placeholder='Message for me?' name='message' />
                  <Button
                     p='20px'
                     bg={'orange'}
                     border={'none'}
